 ...
 * Class:     cn_nju_seg_atg_cppmanager_CppManagerUtil
 * Method:    call
 * Signature: (ILjava/lang/String;I[I[B[C[I[J[F[D)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_cn_nju_seg_atg_cppmanager_CppManagerUtil_call
  (JNIEnv *, jobject, jint, jstring, jint, jintArray, jbyteArray, jcharArray, jintArray, jlongArray, jfloatArray, jdoubleArray);
